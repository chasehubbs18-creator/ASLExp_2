...
psychoJS.start({
  ...
  resources: [
    ...
    {'name': '90_Adducted_Bent_5_Mouth_Lateral_Forward 18.mp4', 'path': '90_Adducted_Bent_5_Mouth_Lateral_Forward 18.mp4'},
    ...
    {'name': '90_R_Elbow_Twist_Self 24.mp4', 'path': '90_R_Elbow_Twist_Self 24.mp4'},
    ...
    {'name': '90_B_Elbow_Circle_Down 3.mp4', 'path': '90_B_Elbow_Circle_Down 3.mp4'},
    ...
    {'name': 'Test_Exp_legacy_lastrun.py', 'path': 'Test_Exp_legacy_lastrun.py'},
